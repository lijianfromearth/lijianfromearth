...
### ShanghaiTech University MARSLab
...
- **High-Quality, ROS Compatible Video Encoding and Decoding for High-Definition Datasets**. Li Jian, Bowen Xu, and Sören Schwertfeger. `ROBIO 2024`
- **Gentle Manipulation Policy Learning via Demonstrations from VLM Planned Atomic Skills**. Jiayu Zhou, Qiwei Wu, Jian Li, Zhe Chen, Xiaogang Xiong, Renjing Xu. `AAAI 2026 Oral`

## Contact

- Email: `lijianonwork@126.com`
- GitHub: [lijianfromearth](https://github.com/lijianfromearth)
